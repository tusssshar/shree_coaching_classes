...
<div class="card card-info card-outline mb-4">
    <!--begin::Header-->
    <div class="card-header"><div class="card-title">Add Board</div></div>
    <!--end::Header-->
    <!--begin::Form-->
    ...
    <div class="card-body">
        ...
        <input type="hidden" name="source_blade" value="board">
        <!--end::Col-->
...
<!--end::Form Validation-->
<?php /**PATH D:\xampp\htdocs\laravel\shree_coaching_classes\resources\views/admin/configurations/add/board.blade.php ENDPATH**/ ?>