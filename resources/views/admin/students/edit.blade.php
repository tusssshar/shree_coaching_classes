...
<div class="card card-info card-outline mb-4">
    ...
    <div class="card-body">
        ...
        <div class="col-md-4">
            ...
            <input type="text" class="form-control @error('name') is-invalid @enderror"
             name="name" value="{{ old('name', $student->first_name) }}"/>
        ...
        <div class="col-md-4">
            ...
            <input type="text" class="form-control @error('mname') is-invalid @enderror"
                name="mname" value="{{ old('mname' ,$student->middle_name) }}">
        ...
        <div class="col-md-4">
            ...
            <input type="text" class="form-control @error('lname') is-invalid @enderror"
                name="lname" value="{{ old('lname',$student->last_name) }}">
        ...
        <div class="col-md-4">
            ...
            <input type="text" class="form-control @error('fmobile') is-invalid @enderror" 
            maxlength="10" name="fmobile" value="{{ old('fmobile',$student->fmobile) }}">
        ...
        <div class="col-md-4">
            ...
            <input type="text" class="form-control @error('mmobile') is-invalid @enderror" 
            maxlength="10" name="mmobile" value="{{ old('mmobile',$student->mmobile) }}">
        </div>
        <!--end::Col-->
        <!--begin::Col-->
        <div class="col-md-4">
            ...
            <option value="{{$item->id}}" {{ old('standard', $student->standard) == $item->id ? 'selected' : '' }}>
                {{$item->name}}
            </option>
            @endforeach
            </select>
        ...
        <div class="col-md-2">
            ...
            <option value="{{$item->id}}" {{ old('medium', $student->medium) == $item->id ? 'selected' : '' }}>
                {{$item->name}}
            </option>
            @endforeach
            </select>
        ...
        <div class="col-md-2">
            ...
            <option value="{{$item->id}}" {{ old('board', $student->board) == $item->id ? 'selected' : '' }}>
                {{$item->name}}
            </option>
            @endforeach
            </select>
        ...
        <div class="col-md-4">
            ...
            name="school"
            value="{{ old('school', $student->schoolname) }}"
            />
            @error('school')
            <div class="text-danger">{{ $message }}</div>
            @enderror
        ...
        <div class="col-md-8">
            ...
            <textarea class="form-control @error('home') is-invalid @enderror" 
            aria-label="With textarea" name="home">{{ old('home', $student->address) }}</textarea>
            @error('home')
            <div class="text-danger">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="col-md-4">
            ...
            id="validationCustom05"
            name="totalfees"
            value="{{ old('totalfees', $student->paymentInfo->total_fees) }}"
            />
            @error('totalfees')
            <div class="text-danger">{{ $message }}</div>
            @enderror
        ...
        <div class="col-md-4">
            ...
            id="validationCustom05"
            name="fees"
            value="{{ old('fees', $student->paymentInfo->paid_amount) }}">
            @error('fees')
            <div class="text-danger">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="col-md-2">
            ...
            <option value="{{ $item->id }}" 
                {{ old('typeofpayment', $student->paymentInfo->type_of_payment) == $item->id ? 'selected' : '' }}>
                {{ $item->name }}
            </option>
            @endforeach
            </select>
        ...
        <div class="col-md-2">
            ...
            <option value="{{ $item->id }}" {{ old('modeofpayment', $student->paymentInfo->mode_of_payment) == $item->id ? 'selected' : '' }}>{{ $item->name }}</option>
            {{$item->name}}
            </option>
            @endforeach
            </select>
    ...
    <div class="col-md-6">
        ...
        @if($student->documentInfo->student_photo)
            <p>Old File: <a href="{{ asset($student->documentInfo->student_photo) }}" target="_blank">View</a></p>
        @endif
        @error('student_photo')
        <div class="text-danger">{{ $message }}</div>
        @enderror
    ...
    <div class="col-md-6">
        ...
        @if($student->documentInfo->government_identity)
            <p>Old File: <a href="{{ asset($student->documentInfo->government_identity) }}" target="_blank">View</a></p>
        @endif
    ...
    <div class="col-md-6">
        ...
        @if($student->documentInfo->last_year_marksheet)
            <p>Old File: <a href="{{ asset($student->documentInfo->last_year_marksheet) }}" target="_blank">View</a></p>
        @endif
        @error('mark_sheet')
        <div class="text-danger">{{ $message }}</div>
        @enderror
